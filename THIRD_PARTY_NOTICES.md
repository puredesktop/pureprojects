...
| --- | --- | --- |
| `jszip` | `^3.10.1` | [jszip](https://github.com/Stuk/jszip) |
| `react` | `^19.1.1` | [react](https://github.com/react/react) |
| `react-dom` | `^19.1.1` | [react-dom](https://github.com/react/react) |
| `styled-components` | `^6.1.19` | [styled-components](https://github.com/styled-components/styled-components) |
